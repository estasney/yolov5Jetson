...
def non_max_suppression_torch_ops(prediction, conf_thres=0.25, iou_thres=0.45,
                                  classes=None, agnostic=False, labels=()):
    """
    Performs Non-Maximum Suppression (NMS) on inference results. v4.0 Implementation
        Returns:
...
def non_max_suppression(prediction, conf_thres=0.1, iou_thres=0.45, merge=False, classes=None, agnostic=False):
...
def color_list():
    return [(31, 119, 180), (255, 127, 14), (44, 160, 44), (214, 39, 40), (148, 103, 189), (140, 86, 75),
            (227, 119, 194),
